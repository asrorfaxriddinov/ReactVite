...
let checkerForFullScreenLogo = setInterval(function () {
    ...
    if (document.querySelector('.native-network-fullscreen')) {
        ...
        document.querySelector('.native-network-fullscreen-header').style.display = "none";



        document.querySelector('.native-network-fullscreen-header').innerHTML = "" ;
...
setTimeout(() => {
    ...
    if(document.querySelector('.interscroller') && document.querySelector('.caramel-bottomline')){
        ...
        else if(window.innerHeight - position.top >= window.innerHeight / 4 * 2 && position.top > -70){
            bottomLineD.style.cssText += 'display: none !important;'
        }
